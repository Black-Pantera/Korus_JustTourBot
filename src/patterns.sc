patterns:
    ...
    $yesWant = ((да|даа|ага|yes|ога|хочу|почему [бы и] нет|давай [ну] [конечно|всё|все|вроде|пожалуй|возможно]|lf|точно|угу|верно|ок|ok|окей|окай|okay|именно|подтвержд*|йес) [да|конечно|конешно|канешна|всё|все|вроде|пожалуй|возможно])
